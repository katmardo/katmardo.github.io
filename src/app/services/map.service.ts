      ...
      for (let i = 0; i < filterCode.length; i++) {
        ...
        if (code[index] === "1") {
          L.marker([lat, lng], {
            ...
            .bindPopup(content, { maxWidth: 200, maxHeight: 200 })
            .addTo(emptyLayer);
          i = filterCode.length;
        }
      }
